...
const NavLinksConfig = [
  { path: '/admin/dashboard', text: t('dashboard'), iconClass: ' fas fa-tv ' },
  { path: '/admin/cheque', text: t('cheques'), iconClass: ' fas fa-file-invoice-dollar ' },
  { path: '/admin/onlineproof', text: t('heartbeats'), iconClass: ' fab fa-chromecast ' },
  { path: '/admin/peers', text: t('peers'), iconClass: ' fas fa-map-marked ' },
  { path: '/admin/files', text: t('files'), iconClass: ' fas fa-file-alt ' },
  { path: '/admin/settings', text: t('settings'), iconClass: ' fas fa-tools ' },
];
