...
export default function Sidebar() {
    ...
    return (
        <>
            <nav
                className={"md:left-0 md:block md:fixed md:top-0 md:bottom-0 md:overflow-y-auto md:flex-row md:flex-nowrap md:overflow-hidden shadow-xl flex flex-wrap items-center justify-between relative z-10 py-4 px-6 " + (themeStyle.bg[theme]) + (sidebarShow ? "md:w-64" : "md:hidden")}>
                <div
                    ...
                    <div className={"flex justify-between " + themeStyle.link[theme]}>
                        <div className="items-center">
                            <Link
                                className={"text-left mr-0 inline-block whitespace-nowrap text-sm uppercase font-bold px-0" + themeStyle.link[theme]}
                                to="/"
                            >
                                <img className="inline-block" src={require('assets/img/btfs_logo.png').default}
                    ...
                    <div
                        className={
                            "md:flex md:flex-col md:items-stretch md:opacity-100 md:relative md:mt-4 md:shadow-none shadow absolute top-0 left-0 right-0 z-40 overflow-y-auto overflow-x-hidden h-auto items-center flex-1 rounded justify-between " +
                    ...
                    >
                        ...
                        <div
                            ...
                            {/*
                            <div className="bg-opacity-50 bg-black absolute top-0 left-0 w-full h-full inset-0 z-40">
                            ...
                            */}
                            <div className="flex justify-between items-center">
                                <div className="w-4/12">
                                    <Link
                                        className={"md:block text-left md:pb-2 mr-0 inline-block whitespace-nowrap text-sm uppercase font-bold p-4 px-0 " + themeStyle.text[theme]}
                                        to="/"
                                    >
                                        BTFS
                                    </Link>
                        ...
                        <div>
                            ...
                            <ul className={"md:flex-col md:min-w-full flex flex-col list-none "} onClick={collapse}>
                                <li className="items-center">
                                    <Link className={"text-xs uppercase py-3 font-bold block hover:text-lightBlue-600 " +
                                ...
                                <li className="items-center">
                                    ...
                                    (window.location.href.indexOf("/admin/peers") !== -1
                                        ...
                                        : (themeStyle.link[theme]))}
                                          to="/admin/peers">
                                        <i className={"w-5 fas fa-map-marked mr-2 text-sm " +
                                        (window.location.href.indexOf("/admin/peers") !== -1 ? "" : "opacity-50")}></i>{" "}
                                        {t('peers')}
                                    </Link>
                                </li>
                                ...
                                <li className="items-center">
                                    ...
                                    (window.location.href.indexOf("/admin/files") !== -1
                                        ...
                                        : (themeStyle.link[theme]))}
                                          to="/admin/files">
                                        <i className={"w-5 fas fa-file-alt mr-2 text-sm " +
                                        (window.location.href.indexOf("/admin/files") !== -1 ? "" : "opacity-50")}></i>{" "}
                                        {t('files')}
                                    </Link>
                                </li>
