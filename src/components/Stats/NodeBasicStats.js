...
export default function NodeBasicStats({color}) {
    ...
    useEffect(() => {
        ...
        const fetchData = async () => {
            let {ID, uptime, peers, version} = await getNodeBasicStats();
            if (!didCancel) {
                setID(ID);
                setUptime(uptime);
                setPeers(peers);
                                ...
                                <div className="flex items-center p-4 h-125-px">
                                    <div className="relative w-3/4 h-75-px flex flex-col justify-between">
                                        ...
                                        <div className="font-semibold">
                                            <a href={'https://scan.btfs.io/#/node/' + ID} target='_blank'
                                               rel='noreferrer'>
                                                <Truncate>
                                                    {ID}
                                                </Truncate>
                            ...
                            <div className={"relative break-words rounded " + themeStyle.bg[color] + themeStyle.text[color]}>
                                <div className="flex items-center p-4 h-125-px">
                                    <div className="relative w-3/4 h-75-px flex flex-col justify-between">
                                        ...
                                        <div className="font-semibold text-red-500 cursor-default">
                                            <Tooltip placement="bottom" title="prompt text" color={color}>
