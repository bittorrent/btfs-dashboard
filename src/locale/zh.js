...
// heartBeats
    ...
    's3_bucket_name_rule_1': '桶名只能由小写字母、数字和连字符（-）组成',
    's3_bucket_name_rule_2': '存储桶名称长度必须在 3 到 48 个字符之间',
    's3_bucket_name_rule_3': '输入超过 40 个字符',
    ...
    's3_add_folder_rule_1': '文件夹名称只能由小写字母、数字、下划线（_）和连字符（-）组成',
    's3_add_folder_rule_2': '入超过 60 个字符',
    ...
    's3_bucket_delete_fail': '删除失败',
    's3_new_bucket_error': '存储桶命名错误',
