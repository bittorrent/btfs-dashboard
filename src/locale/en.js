...
// setting
    ...
    'reset_advance_config_title':'Reset',
    'reset_advance_config_tips':'After restoring the default configuration, you need to restart the service on the client to take effect',
